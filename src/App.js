...
import TalentFulfillmentByiIdView from './components/Talent-Acquisition-Portal/TalentFulfillmentByIdView';
    ...
    <>
      <Router>
        ...
        <Routes>
            ...
            <Route exact path="/create-talent-request" element={<CreateTalentRequestForm />} />

            <Route exact path="/get-all-talent-requests" element={<TalentRequestsView />} />
            ...
            />
            <Route path="/talent-fulfillment/:talentFulfillmentId" element={<TalentFulfillmentByiIdView />} />
            <Route exact path="/career-portal" element={<CareerPortalHome />} />
