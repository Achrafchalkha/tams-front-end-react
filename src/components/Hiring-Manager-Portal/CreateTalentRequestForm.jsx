  ...
  return (
    ...
    <form onSubmit={onSubmit} >
      <div className="form-group">
          ...
          <input type="text" className="form-control" name='talentRequestTitle' value={talentRequestTitle} onChange={onChange} />
      </div>
      <div className="form-group">
        ...
        <div className="form-group">
          <label htmlFor="candidateSkills">Candidate Skills (Core Skill & Skill Level)</label>
          <div className="form-group">
            <select
              name="coreSkill"
              className="form-control"
